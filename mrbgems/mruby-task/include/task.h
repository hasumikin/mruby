 ...
 * Defined in task.c, default to NULL.  Wired up in mrb_mruby_task_gem_init
 * when MRB_USE_TASK_REFINEMENTS is defined; otherwise the call sites in
 * task.c remain cheap NULL checks.
 */
